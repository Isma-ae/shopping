...
<div class="label-box">
    <h3>ผู้รับ:</h3>
    <div class="address">
        ' . nl2br(htmlspecialchars($obj[0]['shipping_name'])) . '<br>
        ' . nl2br(htmlspecialchars($address)) . '
    </div>
    <div class="phone">โทร: ' . htmlspecialchars($obj[0]['shipping_phone']) . '</div>
