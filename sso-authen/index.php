            ...
            <div class="card-body text-center">
                <?php if (isset($_SESSION['user_is_logged_in']) && $_SESSION['user_is_logged_in']): ?>
                    ...
                    <div class="text-center">
                        ...
                        <a href="public/logout.php" class="btn btn-danger">ออกจากระบบ</a>
                    </div>
                <?php else: ?>
                    <h5 class="card-title" style="color:red">คุณยังไม่ได้เข้าสู่ระบบ</h5>
                    <p class="card-text">กรุณาเข้าสู่ระบบเพื่อใช้งาน</p>
                    <div class="text-center">
                        <a href="public/login.php" class="btn btn-primary">Login with PSU SSO</a>
                        <a href="public/login_google.php" class="btn btn-danger">Login with Google</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
