        ...
        <div class="m-l-25 m-r--38 m-lr-0-xl">
            ...
            <div class="bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                ...
                <div class="row receipt_form">
                    ...
                    <div class="col-6 p-b-5">
                        <label class="stext-102 cl3" for="receipt_number">หมายเลขผู้เสียภาษี</label>
                        <input class="size-111 bor8 stext-102 cl2 p-lr-20" id="receipt_number" type="text"
                            name="receipt_number">
                    </div>
                    <div class="col-12">
                        <label class="stext-102 cl3" for="receipt_address">ที่อยู่</label>
                        ...
                        <div class="p-l-13 form-out">
                            ...
                            <form class="w-full" id="form_address" data-mode="add">
                                <div class="row p-b-25">
                                    <div class="col-6 p-b-5">
                                        <label class="stext-102 cl3" for="name">ชื่อ นามสกุล <span
                                                class="clr">*</span></label>
                                    ...
                                    <div class="col-6 p-b-5">
                                        <label class="stext-102 cl3" for="phone">หมายเลขโทรศัพท์ <span
                                                class="clr">*</span></label>
                                        <input class="size-111 bor8 stext-102 cl2 p-lr-20" id="phone" type="text"
                                            name="phone">
                                    </div>
                                    <div class="col-6 p-b-5">
                                        <label class="stext-102 cl3" for="province_id">จังหวัด <span
                                                class="clr">*</span></label>
                                    ...
                                    <div class="col-6 p-b-5">
                                        <label class="stext-102 cl3" for="subdistrict_id">แขวง / ตำบล <span
                                                class="clr">*</span></label>
                                        <select class="js-example-basic-single" name="subdistrict_id"
                                            id="subdistrict_id">
                                        </select>
                                    </div>
                                    <div class="col-6 p-b-5">
                                        <label class="stext-102 cl3" for="zip_code">รหัสไปรษณีย์ <span
                                                class="clr">*</span></label>
                                        <input class="size-111 bor8 stext-102 cl2 p-lr-20" id="zip_code" type="text"
                                            name="zip_code" readonly>
                                    </div>
